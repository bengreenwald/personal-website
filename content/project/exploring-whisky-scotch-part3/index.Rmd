...
```{r, include=FALSE}
#htmltools::tagList(htmltools::tags$script(src = "https://cdn.plot.ly/plotly-latest.min.js"))
```
...
<iframe src="external/whisky/output/brand_plotly.html" width=900 height=600> </iframe> 
